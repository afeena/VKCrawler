...
public class VkResponseParserTest {
	...
	public void wallPostParseText() {
		...
		ArrayList<Post> expected_result = new ArrayList<Post>();
		Post post = new Post(1412280264,"Test case wallPostParseText text");

		expected_result.add(post);

		//act
		VkResponseParser responseParser = new VkResponseParser();
		ArrayList<Post> result = responseParser.parseWall(response, 1);
	...
	public void wallRepostParseText(){
		...
		ArrayList<Post> expected_result = new ArrayList<Post>();
		Post post = new Post(1437051171,"Test case wllRepostPareTest text");
		expected_result.add(post);
		//act
		VkResponseParser responseParser = new VkResponseParser();
		ArrayList<Post> result = responseParser.parseWall(response, 1);
